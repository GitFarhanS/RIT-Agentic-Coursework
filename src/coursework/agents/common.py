...
def get_mid_price(client: RotmanSDK | Any, ticker: str) -> float | None:
...
def get_last_trade_price(client: RotmanSDK | Any, ticker: str) -> float:
...
def wait_for_session_start(client: RotmanSDK | Any, stopped_wait_timeout: float) -> bool:
